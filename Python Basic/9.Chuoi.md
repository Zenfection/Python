...
| Phương thức           | Mô tả                                  | Ví dụ                      | Lưu ý                                                         |
| --------------------- | -------------------------------------- | -------------------------- | ------------------------------------------------------------- |
| capitalize()          | Chuyển ký tự đầu tiên thành **IN HOA** | `"zen".capitalize()` ⇨ Zen |                                                               |
| casefold()<br>lower() | Chuyển chuỗi thành chữ thường          |                            | Nếu là `ASCII` ⇨ `lower()`<br>Nếu là `Unicode` ⇨ `casefold()` |
| center()              |                                        |                            |                                                               |
| count()               |                                        |                            |                                                               |
| encode()              |                                        |                            |                                                               |
| endswith()            |                                        |                            |                                                               |
