...
| ------------------------- | ----------------------------------------------------------------------------------------- | ---------------- | ------------------------------------------------------------- |
| capitalize()              | Chuyển ký tự đầu tiên thành **IN HOA**                                                    | String ⇨ String  |                                                               |
| casefold()<br>lower()     | Chuyển chuỗi thành chữ thường                                                             | String ⇨ String  | Nếu là `ASCII` ⇨ `lower()`<br>Nếu là `Unicode` ⇨ `casefold()` |
| center()                  |                                                                                           |                  |                                                               |
| count()                   | Trả về số lượng từ xuất hiện trong chuỗi                                                  | String ⇨ int     |                                                               |
| encode()                  | Trả về chuỗi được mã hoá                                                                  | String ⇨ String  | s                                                             |
| startwith()<br>endswith() | `True` nếu **bắt đầu** bằng chuỗi chỉ định<br>`True` nếu **kết thúc** bằng chuỗi chỉ định | String ⇨ boolean |                                                               |
